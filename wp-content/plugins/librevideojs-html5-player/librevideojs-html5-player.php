...
EOT;
    ...
    librestyle.className += " cliplibre-js-responsive-container librevjs-hd cliplibre-js librevjs-libre-{$_skin}-skin";
    cliplibrejs('$player',{plugins:{resolutionSelector:{force_types:['video/webm','video/ogg', 'video/mp4'],default_res:"$resolution"}},nativeControlsForTouch:false}).ready(function(){this.hotkeys({volumeStep:0.1,seekStep:5,enableMute:true, enableFullscreen:true,enableNumbers:true,});});
    // @license-end
    </script>
    $style
EOT;
